...
#include "ARogPlayerController.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnPawnChanged, APawn*, NewPawn); // Custom on pawn change event
 ...
 */
UCLASS()
class ACTIONROGUELIKE_API AARogPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	// Pause menu code goes down below
