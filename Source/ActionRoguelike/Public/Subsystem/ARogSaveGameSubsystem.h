...
#include "ARogSaveGameSubsystem.generated.h"

class UARogSaveGame;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnSaveGameSignature, class UARogSaveGame*, SaveObject);
...
class ACTIONROGUELIKE_API UARogSaveGameSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
